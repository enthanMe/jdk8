 ...
 *
 * The default file system, obtained by invoking the {@link FileSystems#getDefault
 ...
 *
 * <ul>
 *   <li>The {@link #getPath getPath} method converts a system dependent
 *     <em>path string</em>, returning a {@link Path} object that may be used
 *     to locate and access a file. </p></li>
 *   <li>The {@link #getPathMatcher  getPathMatcher} method is used
 *     to create a {@link PathMatcher} that performs match operations on
 *     paths. </p></li>
 *   <li>The {@link #getFileStores getFileStores} method returns an iterator
 *     over the underlying {@link FileStore file-stores}. </p></li>
 *   <li>The {@link #getUserPrincipalLookupService getUserPrincipalLookupService}
 *     method returns the {@link UserPrincipalLookupService} to lookup users or
 *     groups by name. </p></li>
 *   <li>The {@link #newWatchService newWatchService} method creates a
 ...
 * cannot be closed.
 *
 * A {@code FileSystem} can provide read-only or read-write access to the
 ...
 *
 * File systems are safe for use by multiple concurrent threads. The {@link
    ...
    implements Closeable
{
     ...
     *
     *   <li>The {@code { }} characters are a group of subpatterns, where
     *   the group matches if any subpattern in the group matches. The {@code ","}
     *   character is used to separate the subpatterns. Groups cannot be nested.
     *   </p></li>
     *
     *   <li>Leading period<tt>&#47;</tt>dot characters in file name are
     ...
     *   </p></li>
     *
     *   <li>All other characters match themselves in an implementation
     *   dependent manner. This includes characters representing any {@link
     *   FileSystem#getSeparator name-separators}. </p></li>
     *
     *   <li>The matching of {@link Path#getRoot root} components is highly
